...
import { useCart } from '../components/CartContext'; // আপনার কার্ট কনটেক্সট পাথ ঠিক আছে কিনা খেয়াল করবেন

// ডাইনামিক এনভায়রনমেন্ট ভেরিয়েবল কল করা হলো (যেহেতু এটি 'use client', তাই Next.js-এর পাবলিক ভেরিয়েবলগুলো ক্লায়েন্ট সাইডে ব্যবহার করা হচ্ছে। তবে সিকিউরিটির জন্য API কল সার্ভার সাইডে হওয়াই ভালো, কিন্তু বর্তমান স্ট্রাকচারের জন্য নিচে আপডেট করে দেওয়া হলো)
...
function CustomCheckoutContent() {
  ...
  const handleOrderSubmit = async (e) => {
    ...
    if (!formData.trxId) {
      alert("দয়া করে আপনার পেমেন্ট ট্রানজেকশন আইডি বা যে নাম্বার থেকে টাকা পাঠিয়েছেন সেটি দিন।");
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        localStorage.removeItem('cart'); // সফল হলে কার্ট ক্লিয়ার
      } else {
          ...
          <div className="space-y-4">
            ...
            <div className="bg-teal-50 p-4 rounded-lg border border-teal-200 mt-2">
              <label className="block text-sm font-bold text-teal-800 mb-2">
                বিকাশ/ন নগদ ট্রানজেকশন আইডি (বা যে নাম্বার থেকে টাকা পাঠিয়েছেন) *
              </label>
